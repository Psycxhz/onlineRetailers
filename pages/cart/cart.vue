...
<script>
	...
	export default {
		...
		methods:{
			...mapMutations('moduleCart',["deleteGoods","undatagoodscount","undatagoodschecked","updateAllGoodsChecked"]),
			//点击左滑出现的删除按钮
			swipeClick(goods_id){
